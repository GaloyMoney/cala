...
- Bump obix
- Bump the all-dependencies group across 1 directory with 2 updates (#885)
...
- [**breaking**] Bump obix to 0.10.0, job to 0.13.17 (#882)
...
- [**breaking**] Bump job to 0.12.0, obix to 0.8.6 (#854)
...
- Post a transaction and print balances (#846)

### Features

- EffectiveBalances::list_modified_since — CDC watermark query (#849)
...
- Compile CEL on a dedicated big-stack thread (#823)
...
# [cala release v0.15.7](https://github.com/GaloyMoney/cala/releases/tag/0.15.7)



### Miscellaneous Tasks

- Remove err from instrument on tx_template.prep_entries (#716)
...
- Bump es-entity to 0.10.34, job to 0.6.19, obix to 0.2.25 (#709)

# [cala release v0.15.2](https://github.com/GaloyMoney/cala/releases/tag/0.15.2)



### Miscellaneous Tasks

- Bump job 0.6.18, obix 0.2.21 (#708)
- Bump rand from 0.10.0 to 0.10.1 (#707)
...
- Bump es-entity to 0.10.32, job to 0.6.13, obix to 0.2.19 (#694)
...
# [cala release v0.13.11](https://github.com/GaloyMoney/cala/releases/tag/0.13.11)
...
# [cala release v0.13.4](https://github.com/GaloyMoney/cala/releases/tag/0.13.4)
...
# [cala release v0.13.3](https://github.com/GaloyMoney/cala/releases/tag/0.13.3)
